          ...
          <fieldset>
              ...
              <table width="100%"  class="table_form">
                <tr>
                    ...
                    <td class="y-bg"><input type="text" class="input-text" name="setting[imageAllowFiles]" id="imageAllowFiles" size="50" value="<?php echo $setting['imageAllowFiles']?>"/></td>
                </tr>
                <tr>
                    <th width="130" valign="top"><?php echo L('ueditor_catcher_allow_ext')?></th>
                    <td class="y-bg"><input type="text" class="input-text" name="setting[catcherAllowFiles]" id="catcherAllowFiles" size="50" value="<?php echo $setting['catcherAllowFiles']?>"/></td>
                </tr>
                <tr>
                    <th width="130" valign="top"><?php echo L('ueditor_video_allow_ext')?></th>
                    <td class="y-bg"><input type="text" class="input-text" name="setting[videoAllowFiles]" id="videoAllowFiles" size="50" value="<?php echo $setting['videoAllowFiles']?>"/></td>
                </tr>
                <tr>
                    <th width="130" valign="top"><?php echo L('ueditor_file_allow_ext')?></th>
                    <td class="y-bg"><input type="text" class="input-text" name="setting[fileAllowFiles]" id="fileAllowFiles" size="50" value="<?php echo $setting['fileAllowFiles']?>"/></td>
                </tr>
                <tr>
                    <th width="130" valign="top"><?php echo L('ueditor_imagemanager_allow_ext')?></th>
                    <td class="y-bg"><input type="text" class="input-text" name="setting[imageManagerAllowFiles]" id="imageManagerAllowFiles" size="50" value="<?php echo $setting['imageManagerAllowFiles']?>"/></td>
                </tr>
                <tr>
                    <th width="130" valign="top"><?php echo L('ueditor_filemanager_allow_ext')?></th>
                    <td class="y-bg"><input type="text" class="input-text" name="setting[fileManagerAllowFiles]" id="fileManagerAllowFiles" size="50" value="<?php echo $setting['fileManagerAllowFiles']?>"/></td>
                </tr>
            </table>
        </fieldset>
    </td>
