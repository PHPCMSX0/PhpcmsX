...
<ul class="tabBut cu-li">
            ...
            <li id="tab_setting_5" onclick="SwapTab('setting','on','',6,5);"><?php echo L('setting_fenci_cfg')?></li>
			<li id="tab_setting_6" onclick="SwapTab('setting','on','',6,6);"><?php echo L('setting_connect')?></li>
</ul>
...
<div id="div_setting_5" class="contentList pad-10 hidden">
        <table width="100%"  class="table_form">
            <tr>
                <th width="120">PHPCMSX接口:</th>
                <td class="y-bg" width="200">
                    <input type="radio" name="setconfig[cwsapi]" value="0"<?php if($cwsapi==0){echo ' checked';}  ?>> PHPCMSX 智能分词 <span style="color: #f00">[推荐:永久免费/更加人性化]</span> &nbsp;&nbsp;
                </td>
                <td></td>
            </tr>
            <tr>
                <td colspan="2"><strong>提醒 :</strong> PHPCMS X的提词个数和最下方百度提词个数共用设置</td>
            </tr>

            <tr>
                <th width="120">启用讯飞接口:</th>
                <td class="y-bg" width="200">
                    <input type="radio" name="setconfig[cwsapi]" value="1"<?php if($cwsapi==1){echo ' checked';}  ?>> 讯飞接口&nbsp;&nbsp;
                </td>
                <td></td>
            </tr>
            <tr>
                <th width="120"><?php echo L('setting_xunfei_appid')?></th>
                <td class="y-bg" width="200">
                    <input type="text" class="input-text" name="setconfig[xunfei_appid]" placeholder="您的讯飞关键词提取接口APPid" id="xunfei_appid" size="40" value="<?php echo $xunfei_appid ?>"/>
                </td>
                <td rowspan="2">
                    <a href="https://console.xfyun.cn/services/ke" target="_blank">[点击这里免费注册讯飞开放平台关键词提取接口]</a><br>
                    请先去注册讯飞开放平台账号,注册后进入'控制台' - '自然语言处理' - '关键词提取',开通后可看到APPID和APIK<br>
                    讯飞开放平台关键词提取服务每天有<span style="color:#f00">500次请求额度</span>,长期使用还可免费增长,<a href="http://wpa.qq.com/msgrd?v=3&uin=95606117&site=ue4PHPCMS&menu=yes">[点击这里]获取免费指导</a><br>
                </td>
            </tr>
            <tr>
                <th width="120"><?php echo L('setting_xunfei_appkey')?></th>
                <td colspan="y-bg">
                    <input type="text" class="input-text" name="setconfig[xunfei_apikey]" placeholder="您的讯飞关键词提取接口APIkey" id="xunfei_apikey" size="40" value="<?php echo $xunfei_apikey ?>"/> <a href="https://console.xfyun.cn/services/cws-pos-ner" target="_blank"></a>
                </td>
            </tr>
            <tr>
                <th width="120">启用百度接口:</th>
                <td class="y-bg" width="200">
                    <input type="radio" name="setconfig[cwsapi]" value="2"<?php if($cwsapi==2){echo ' checked';}  ?>> 百度接口&nbsp;&nbsp;
                </td>
                <td></td>
            </tr>
            <tr>
                <th width="120"><?php echo L('setting_baidu_appid')?></th>
                <td class="y-bg" width="200">
                    <input type="text" class="input-text" name="setconfig[baidu_appid]" placeholder="您的百度关键词提取接口APPid" id="baidu_appid" size="40" value="<?php echo $baidu_appid ?>"/>
                </td>
                <td rowspan="4">
                    <a href="http://ai.baidu.com/tech/nlp/lexical" target="_blank">[点击这里百度AI开放平台中文分词接口]</a><br>
                    请先去注册百度AI开放平台账号,注册后进入'控制台' - '自然语言处理' - '中文分词',开通后可看到APPID,APIKey和SecretKey<br>
                    百度AI开放平台提供<span style="color:#f00">500000次额度</span>,<a href="http://wpa.qq.com/msgrd?v=3&uin=95606117&site=ue4PHPCMS&menu=yes">[点击这里]获取免费指导</a><br>
                </td>
            </tr>
            <tr>
                <th width="120"><?php echo L('setting_baidu_apikey')?></th>
                <td colspan="y-bg">
                    <input type="text" class="input-text" name="setconfig[baidu_apikey]" placeholder="您的百度关键词提取接口APIkey" id="baidu_apikey" size="40" value="<?php echo $baidu_apikey ?>"/>
                </td>
            </tr>
            <tr>
                <th width="120"><?php echo L('setting_baidu_Secretkey')?></th>
                <td colspan="y-bg">
                    <input type="text" class="input-text" name="setconfig[baidu_secretkey]" placeholder="您的百度关键词提取接口SecretKey" id="baidu_secretkey" size="40" value="<?php echo $baidu_secretkey ?>"/>
                </td>
            </tr>
            <tr>
                <th width="120"><?php echo L('setting_baidu_qcnum')?></th>
                <td colspan="y-bg">
                    <input type="text" class="input-text" name="setconfig[baidu_qcnum]" placeholder="每次分词个数" id="baidu_qcnum" size="40" value="<?php echo $baidu_qcnum ?>"/>
                </td>
            </tr>
