...
<link rel="alternate stylesheet" type="text/css" href="<?php echo CSS_PATH?>muntime/styles3.css" title="styles3" media="screen" />
    <style>
        .ue4_top_left,.ue4_top_center{display:block;padding:0 10px;float:left;}
        .ue4_top_center {width: 370px;height:24px;color:#ffff00;padding-left:10px;margin:0 5px;overflow:hidden;position:relative;}
        .ue4_top_center b {line-height:24px;font-weight:700;display:inline-block}
        .remote_notice{line-height:24px;display:inline-block;position:absolute;top:0;left:72px}
        ul.remote_notice li span {color: #a7b1c2!important;}
        .remote_notice a{color:#fff}
    </style>
...
$(document).ready(function() {
    setInterval('AutoScroll("#rnotice")',3000);
});
</script>
...
<div class="header">
    ...
    <div class="rt-col">
    	<div class="tab_style white cut_line text-r"><a href="javascript:;" onclick="lock_screen()"><img src="<?php echo IMG_PATH.'icon/lockscreen.png'?>"> <?php echo L('lockscreen')?></a><span>|</span><a href="http://www.phpcmsx.com" target="_blank">PHPCMS X</a><span>|</span><a href="http://bbs.phpcmsx.com" target="_blank"><?php echo L('igenus_for_postfix')?></a><span>|</span><a href="https://bbs.phpcmsx.com/forum.php?mod=forumdisplay&fid=2" target="_blank"><?php echo L('help')?></a>
    <ul id="Skin">
    ...
    <div class="col-auto">
        <div class="log white cut_line">
            ...
            <div class="ue4_top_center" id="rnotice">
                <b>维护动态:</b>
                <ul class="remote_notice">
                    <?php echo $noticeStr; ?>
                </ul>
            </div>
        </div>
