...
//index
$LANG['admin_site_title'] = 'PHPCMS X - 后台管理中心';
$LANG['expand_or_contract'] = '展开与收缩';
$LANG['phpcms_title'] = 'PHPCMS X内容管理系统';
...
$LANG['main_safety_permissions'] = '※ 建议您将phpcmsx目录设置为755（linux）或只读（windows），<a href="http://www.phpcmsx.com" target="_blank">点击查看教程</a>';
...
//分词
$LANG['setting_fenci_cfg'] = '关键词提取接口';
$LANG['setting_xunfei_appid'] = '讯飞分词APPid';
$LANG['setting_xunfei_appkey'] = '讯飞分词APPkey';
$LANG['setting_baidu_appid'] = '百度分词APPid';
$LANG['setting_baidu_apikey'] = '百度分词APIkey';
$LANG['setting_baidu_Secretkey'] = '百度分词SecretKey';
$LANG['setting_baidu_qcnum'] = '百度提词个数';
...
$LANG['setting_phpsso_type'] = '请填写接口地址，格式为：http://www.phpcmsx.com,结尾不包含“/”';
...
$LANG['domain_name_format'] = '域名可为空，格式应该为http://www.phpcmsx.com/';
$LANG['domain_end_string'] = '格式应该为http://www.phpcmsx.com/，请以‘/’结束';
...
$LANG['site_domain_ex'] = '请填写域名，格式为：http://www.phpcmsx.com/';
$LANG['site_domain_ex2'] = '格式应该为http://www.phpcmsx.com/，请以‘/’结束';
...
$LANG['category_does_not_allow_delete_child'] = '该栏目下存在子栏目，请先删除子栏目';
