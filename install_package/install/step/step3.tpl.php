...
<fieldset>
	...
	<div class="content">
    	<input type="radio" name="install_phpsso" id="install_phpsso_1" value="1" onclick="set_sso_hidden()">&nbsp;&nbsp;全新安装PHPCMS X (含 PHPSSO)<br/>
        <input type="radio" name="install_phpsso" id="install_phpsso_2" value="2" onclick="set_sso()">&nbsp;&nbsp;仅安装PHPCMS X (手工指定已经安装的PHPSSO)
    </div>
